...
-- Find the highest version of the nextX.Y folder within a given path
function M.get_highest_net_folder(bin_debug_path)
  ...
  if dirs == 0 then
    error("Not netX.Y folders found in " .. bin_debug_path)
  end

  table.sort(dirs, function(a, b) -- Sort the directories based on their version nums
